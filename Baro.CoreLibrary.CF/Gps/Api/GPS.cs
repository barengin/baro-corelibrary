...
namespace Baro.CoreLibrary.Gps.Api
{
    ...
    public class Gps : IDisposable
    {
        ...
        private void CreateGpsEventThread()
        {
            ...
            if (gpsEventThread == null && gpsHandle != IntPtr.Zero)
            {
                ...
                gpsEventThread.Name = "GpsApi Thread";
                gpsEventThread.IsBackground = true;
                ...
                if (obj != waitFailed)
                {
                    switch (obj)
                    {
                        ...
                        case 1:
                            ...
                            {
                                GpsDeviceState state = GetDeviceState();

                                if (state != null)
                                    deviceStateChanged(this, new DeviceStateChangedEventArgs(state));
                            }
                            break;
                        case 2:
                            ...
                            if (locationChanged != null)
                            {
                                ...
                                if (position != null)
                                    locationChanged(this, new LocationChangedEventArgs(position));
                            }
                            break;
                    }
                }
